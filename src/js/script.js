...
window.addEventListener('scroll', function () {
    ...
    const section2Position2 = section2.offsetTop;
    const section4Position2 = section4.offsetTop;
    const section6Position2 = section6.offsetTop;
    const section7Position2 = section7.offsetTop;
    const section9Position2 = section9.offsetTop;
    const section10Position2 = section10.offsetTop;
    const section12Position2 = section12.offsetTop;
    const section13Position2 = section13.offsetTop;
    const section14Position2 = section14.offsetTop;
    console.log(section2Position,"section2Position");
    console.log(section2Position2,"section2Position2");

    if (section2Position < 250) {
